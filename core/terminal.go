...
const terminalPS1Pattern = `PS1=\\033[38;5;11mdagger@%s:\w$ \\033[0m`
...
func (container *Container) Terminal(
	...
	return container.terminal(ctx, svcID, container, args)
}
...
func (dir *Directory) Terminal(
	...
	return ctr.terminal(ctx, svcID, ctr, args)
}
...
func (container *Container) terminal(
	...
	container = container.Clone()
	container.Config.Env = append(container.Config.Env, fmt.Sprintf(terminalPS1Pattern, svcID.Display()))
	container, err := container.WithExec(ctx, ContainerExecOpts{
		Args:                          args.Cmd,
		SkipEntrypoint:                true,
		ExperimentalPrivilegedNesting: *args.ExperimentalPrivilegedNesting,
